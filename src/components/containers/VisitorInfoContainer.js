...
import { BasicTextAlertContainer } from "../AlertContainer"
...
const alertTranslator = alert => {
  if (alert.includes("Error: ValidationError: name:"))
    return "Please Input a name longer than 3 characters"
  if (alert.includes("Error: ValidationError: email:"))
    return "Please Input an email longer than 5 characters"
